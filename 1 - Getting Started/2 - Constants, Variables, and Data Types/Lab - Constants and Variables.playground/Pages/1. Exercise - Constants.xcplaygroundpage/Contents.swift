...
print("Because a constant has a type that cannot be changed. re-assigning a value to it brings an error in the compiler to ensure safe programming practices.");
