...
let thisWorkout = RunningWorkout.init(distance: 3200, time: 8, elevation: 20)
print(thisWorkout.averageMileTime)
/*:
...
var currentSteps = Steps.init(steps: 9999, goal: 10000)
