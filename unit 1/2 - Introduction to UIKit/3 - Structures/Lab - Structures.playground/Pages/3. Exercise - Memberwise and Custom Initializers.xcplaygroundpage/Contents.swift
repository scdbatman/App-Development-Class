...
let firstLaptop = Laptop.init(yearPurchased: 2020)
let secondLaptop = Laptop.init(yearPurchased: 2022)
...
let inchesVal = 65.0
let centimetersVal = inchesVal * 2.54


print(centimetersVal)
...
var someonesHeight = Height.init(heightInInches: inchesVal, heightInCentimeters: centimetersVal)
...
var myHeight = Height.init(heightInInches: 72, heightInCentimeters: 72 * 2.54)
print(myHeight)
/*:
