...
let myRectangle = Rectangle.init(width: 10, height: 100)
...
struct Height {
    ...
    var heightInInches: Double {
        didSet {
            // If heightInInches changes, update heightInCentimeters
    ...
    var heightInCentimeters: Double {
        didSet {
            // If heightInCentimeters changes, update heightInInches
...
var myHeight = Height.init(heightInInches: 2000)
print(myHeight.heightInCentimeters)
myHeight.heightInCentimeters = 2000;
print(myHeight.heightInCentimeters)
