...
class Spaceship{
    ...
    init(_ name: String, health: Int, position: Int){
        self.name = name
        self.health = health
...
let destroyer = Fighter.init("Destroyer", health: 10, position: 2)
...
print("I did not initialize weapon as a value for falcon only for fighter")
