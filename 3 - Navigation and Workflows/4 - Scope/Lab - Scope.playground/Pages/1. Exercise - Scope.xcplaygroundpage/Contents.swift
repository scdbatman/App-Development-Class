...
//print("The value of foo is \(foo)")
//because the scope of foo is only in the for loop and cannot be accessed outside
...
//you defined x outside of the scope of the for loop so it is accessable in and outside of the loop
...
greeting(greeting: "Hi there", name: "Sarah")
greeting(greeting: nil, name: "Sarah")
...
let myCar = Car(make: "Toyota", model: "Tacoma", year: 2023)
print(myCar.make)
/*:
